...
class Model_Live {
    ...
    public function getLiveData() {
        $query = DB::query(Database::SELECT, "SELECT last_communication, pump_on, DATE_SUB(CURDATE(),INTERVAL 2 MINUTE) <= last_communication AS still_alive FROM live WHERE id_live = 1");
